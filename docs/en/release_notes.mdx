...
This is the initial release of <Term name="product" /> Hosted Control Plane, introducing a new approach to Kubernetes cluster management where control plane components run as standard workloads on a management cluster, decoupled from the data plane.
